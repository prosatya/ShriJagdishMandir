 ...
 */
public class AvlighatCardFragment extends Fragment {
    ...
    public static AvlighatCardFragment newInstance(int position) {
        AvlighatCardFragment f = new AvlighatCardFragment();
        Bundle b = new Bundle();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        ...
        if(position==0)
        {
            itemView1=inflater1.inflate(R.layout.pager_avlighat1, null);
