 ...
 */
public class HaridwarCardFragment extends Fragment {
    ...
    public static HaridwarCardFragment newInstance(int position) {
        HaridwarCardFragment f = new HaridwarCardFragment();
        Bundle b = new Bundle();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        ...
        if(position==0)
        {
            itemView1=inflater1.inflate(R.layout.pager_haridwar1, null);
