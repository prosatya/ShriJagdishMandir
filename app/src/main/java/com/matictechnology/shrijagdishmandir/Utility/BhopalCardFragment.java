 ...
 */
public class BhopalCardFragment extends Fragment {
    ...
    public static BhopalCardFragment newInstance(int position) {
        BhopalCardFragment f = new BhopalCardFragment();
        Bundle b = new Bundle();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        ...
        if(position==0)
        {
            itemView1=inflater1.inflate(R.layout.pager_bhopal1, null);
