 ...
 */
public class DarshanListAdapter extends ArrayAdapter<String>
{
    Context context;
    ArrayList<String> darshan_templename=new ArrayList<>();
    ArrayList<String> darshan_text=new ArrayList<>();
    ArrayList<Integer> darshan_imagename1=new ArrayList<>();

    public DarshanListAdapter(Context c, int resource, ArrayList<String> templename, ArrayList<String> text, ArrayList<Integer> imagename1)
    {
        super(c, resource, templename);
        context=c;
        darshan_templename=templename;
        darshan_text=text;
        darshan_imagename1=imagename1;
    }

    public View getView(final int position,View convertView, ViewGroup parent)
    {
        LayoutInflater inflater = (LayoutInflater) context.getSystemService( Context.LAYOUT_INFLATER_SERVICE );
        View itemView=inflater.inflate(R.layout.item_darshan, null);
        ...
        darshan_image.setImageResource(darshan_imagename1.get(position));
