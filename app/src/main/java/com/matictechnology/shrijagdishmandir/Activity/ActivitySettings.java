...
public class ActivitySettings extends AppCompatActivity implements View.OnClickListener
{
    ...
    public void onClick(View v)
    {
        ...
        if (v.getId() == R.id.ujjain)
        {
            ...
            Intent in=new Intent(ActivitySettings.this, ActivityUjjain.class);
            startActivity(in);
        ...
        if (v.getId() == R.id.haridwar)
        {
            ...
            Intent in=new Intent(ActivitySettings.this,ActivityHaridwar.class);
            startActivity(in);
        ...
        if (v.getId() == R.id.bhopal)
        {
            ...
            Intent in=new Intent(ActivitySettings.this, ActivityBhopal.class);
            startActivity(in);
        ...
        if (v.getId() == R.id.awlighat)
        {
            ...
            Intent in=new Intent(ActivitySettings.this,ActivityAvlighat.class);
            startActivity(in);
        ...
        if (v.getId() == R.id.omkareshwar)
        {
            ...
            Intent in=new Intent(ActivitySettings.this,ActivityOmkareshwar.class);
            startActivity(in);
        ...
        if (v.getId() == R.id.center_item)
        {
            ...
            {
                //starting contact us
                Intent in=new Intent(ActivitySettings.this,ActivityContactUs.class);
                startActivity(in);
            ...
            else if(center_item_flag==0)
            {
                ...
                Intent in=new Intent(ActivitySettings.this,ActivityRegister.class);
                startActivity(in);
            }
        }
    }
    ...
    private void onFabClick(View v)
    {
        ...
        dbhelper = new DbHelper(ActivitySettings.this);
