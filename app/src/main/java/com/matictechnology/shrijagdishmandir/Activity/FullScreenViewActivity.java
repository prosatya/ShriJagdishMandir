...
public class FullScreenViewActivity extends Activity implements View.OnClickListener
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		DbHelper dbhelper = new DbHelper(FullScreenViewActivity.this);
	...
	public void onClick(View v)
	{
		...
		if (v.getId() == R.id.ujjain)
		{
			...
			Intent in=new Intent(FullScreenViewActivity.this, ActivityUjjain.class);
			startActivity(in);
		...
		if (v.getId() == R.id.haridwar)
		{
			...
			Intent in=new Intent(FullScreenViewActivity.this,ActivityHaridwar.class);
			startActivity(in);
		...
		if (v.getId() == R.id.bhopal)
		{
			...
			Intent in=new Intent(FullScreenViewActivity.this, ActivityBhopal.class);
			startActivity(in);
		...
		if (v.getId() == R.id.awlighat)
		{
			...
			Intent in=new Intent(FullScreenViewActivity.this,ActivityAvlighat.class);
			startActivity(in);
		...
		if (v.getId() == R.id.omkareshwar)
		{
			...
			Intent in=new Intent(FullScreenViewActivity.this,ActivityOmkareshwar.class);
			startActivity(in);
		...
		if (v.getId() == R.id.center_item)
		{
			...
			{
				//starting contact us
				Intent in=new Intent(FullScreenViewActivity.this,ActivityContactUs.class);
				startActivity(in);
			...
			else if(center_item_flag==0)
			{
				...
				Intent in=new Intent(FullScreenViewActivity.this,ActivityRegister.class);
				startActivity(in);
			}
		}
	}
	...
	private void onFabClick(View v)
	{
		...
		dbhelper = new DbHelper(FullScreenViewActivity.this);
