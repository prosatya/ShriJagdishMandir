...
public class ActivityNotiMsg extends AppCompatActivity implements View.OnClickListener
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        DbHelper dbhelper = new DbHelper(ActivityNotiMsg.this);
    ...
    public void onClick(View v)
    {
        ...
        if (v.getId() == R.id.ujjain)
        {
            ...
            Intent in=new Intent(ActivityNotiMsg.this, ActivityUjjain.class);
            startActivity(in);
        ...
        if (v.getId() == R.id.haridwar)
        {
            ...
            Intent in=new Intent(ActivityNotiMsg.this,ActivityHaridwar.class);
            startActivity(in);
        ...
        if (v.getId() == R.id.bhopal)
        {
            ...
            Intent in=new Intent(ActivityNotiMsg.this, ActivityBhopal.class);
            startActivity(in);
        ...
        if (v.getId() == R.id.awlighat)
        {
            ...
            Intent in=new Intent(ActivityNotiMsg.this,ActivityAvlighat.class);
            startActivity(in);
        ...
        if (v.getId() == R.id.omkareshwar)
        {
            ...
            Intent in=new Intent(ActivityNotiMsg.this,ActivityOmkareshwar.class);
            startActivity(in);
        ...
        if (v.getId() == R.id.center_item)
        {
            ...
            {
                //starting contact us
                Intent in=new Intent(ActivityNotiMsg.this,ActivityContactUs.class);
                startActivity(in);
            ...
            else if(center_item_flag==0)
            {
                ...
                Intent in=new Intent(ActivityNotiMsg.this,ActivityRegister.class);
                startActivity(in);
            }
        }
    }
    ...
    private void onFabClick(View v)
    {
        ...
        dbhelper = new DbHelper(ActivityNotiMsg.this);
